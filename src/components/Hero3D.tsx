...
const FloatingShape = ({
  ...
  return <Float speed={2} rotationIntensity={0.4} floatIntensity={1}>
...
const Hero3D = () => {
  ...
  return <section id="home" className={`relative min-h-screen flex items-center justify-center overflow-hidden ${theme === 'water' ? '' : 'bg-gradient-hero'}`}>
      {/* 3D Background */}
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        delay: 0.1
          ...
          <span className="text-yellow">{isLoading ? "Loading..." : firstName}</span>
          <br />
        ...
        delay: 0.2
          ...
          {roles.map((role, index) => <span key={role} className="flex items-center gap-2 sm:gap-3">
        ...
        delay: 0.4
          ...
          <Link to="/projects" className="px-6 sm:px-7 py-3 sm:py-3.5 rounded-xl font-heading text-sm sm:text-base
