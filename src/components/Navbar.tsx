      ...
      ease: "easeOut"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className={`flex items-center justify-between rounded-2xl px-4 sm:px-6 py-2.5 sm:py-3 transition-all duration-300 ${isScrolled ? 'glass-card' : ''}`}>
            {/* Logo */}
            <Link to="/" className="<script src=\"https://cdn.lordicon.com/lordicon.js\"></script>\n<lord-icon\n    src=\"https://cdn.lordicon.com/uufkkpxl.json\"\n    trigger=\"hover\"\n    style=\"width:250px;height:250px\">\n</lord-icon>">
              AD
            </Link>
            ...
            {/* CTA Button */}
            <Link to="/contact" className="hidden lg:flex items-center gap-2 px-5 py-2.5 rounded-xl font-heading font-semibold text-sm text-primary-foreground bg-gradient-to-r from-primary to-accent hover:shadow-glow-cyan transition-all duration-300 hover:scale-105">
