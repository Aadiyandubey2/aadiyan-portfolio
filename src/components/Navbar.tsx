...
const Navbar = () => {
  ...
  return <>
      ...
      duration: 0.6,
      ease: "easeOut"
    }} className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "py-3" : "py-5"}`} role="navigation" aria-label="Main navigation">
        ...
        duration: 0.3
          ...
          delay: 0.1
              ...
              delay: (navLinks.length + 1) * 0.1
                  ...
                  <Link to="/contact" onClick={() => setIsMobileMenuOpen(false)} className="block mt-4 px-4 py-3 rounded-xl font-heading font-semibold text-center text-primary-foreground from-primary to-accent bg-[#0da2e7]">
                    Let's Talk
                  </Link>
                </motion.div>
              </div>
