      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center">
          ...
          <motion.button
            ...
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.95 }}
            className="mb-8 w-12 h-12 rounded-full glass-card flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-colors group"
          >
          ...
          <motion.a
            ...
            className="font-heading font-bold text-3xl neon-text mb-4 hover:scale-105 transition-transform"
          >
            AD
          </motion.a>
