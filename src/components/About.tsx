...
const About = () => {
  ...
  return <section id="about" className="relative py-16 sm:py-24 md:py-32 overflow-hidden">
      {/* 3D Background */}
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6" ref={ref}>
        ...
        duration: 0.5
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4">
            About <span className="neon-text text-blue-700">Me</span>
          </h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          delay: 0.1
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <motion.div className="w-28 h-28 mx-auto mb-5 rounded-2xl overflow-hidden border-2 border-primary/30 shadow-lg relative" whileHover={{
              scale: 1.05,
              rotateY: 10
            }} transition={{
              duration: 0.3
                ...
                <img src={profileImage} alt={name} className="w-full h-full object-cover relative z-10" loading="lazy" decoding="async" />
          ...
          delay: 0.2
            ...
            <div className="relative">
              ...
              <div className="space-y-4">
                {timeline.map((item, index) => <motion.div key={`${item.year}-${item.title}`} initial={{
                opacity: 0,
                x: 20
              }} animate={isInView ? {
                opacity: 1,
                ...
                delay: 0.3 + index * 0.1
                    ...
                    <div className="glass-card p-4 rounded-xl">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        {item.status === 'current' && <span className="text-[10px] font-mono text-green-400">Current</span>}
                      </div>
