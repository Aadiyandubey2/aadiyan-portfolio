              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:aadiyandubey@gmail.com" className="font-body font-medium hover:text-primary transition-colors text-sm sm:text-base">aadiyandubey@gmail.com</a>
                  </div>
                </div>
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+917477257790" className="font-body font-medium hover:text-primary transition-colors text-sm sm:text-base">+91 7477257790</a>
                  </div>
                </div>
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body font-medium text-sm sm:text-base">NIT Nagaland, India</p>
                  </div>
                </div>
              </div>
