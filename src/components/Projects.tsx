            ...
            <div className="flex flex-col md:flex-row gap-4 sm:gap-6">
              ...
              <div className="flex-1 flex flex-col">
                <div className="flex flex-col gap-3 mb-4">
                  ...
                  {projectData.url && <a href={projectData.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-heading font-semibold text-xs text-primary-foreground  from-primary to-accent hover:shadow-glow-cyan transition-all whitespace-nowrap self-start bg-blue-700">
                      Visit Site
